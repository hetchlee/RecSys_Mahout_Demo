...
public class MyObjectMapperProvider implements ContextResolver<ObjectMapper> {
	...
	private static ObjectMapper createCombinedObjectMapper() {
		...
		standard.configure(DeserializationConfig.Feature.UNWRAP_ROOT_VALUE,
				true);
		standard.setDeserializationConfig(standard.getDeserializationConfig()
				.withAnnotationIntrospector(combinedIntrospector));
		standard.setSerializationConfig(standard.getSerializationConfig()
				.withAnnotationIntrospector(combinedIntrospector));
