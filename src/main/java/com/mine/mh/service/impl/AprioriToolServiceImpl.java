...
import com.mine.mh.entity.FrequentItem;
import com.mine.mh.service.IAprioriToolService;

public class AprioriToolServiceImpl implements IAprioriToolService {
	IRecDao recDao;
	// 最小支持度计数
	...
	// 初始获取单个用户的景点集
	private ArrayList<String[]> poiNumArray;
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mine.mh.service.impl.IAprioriToolService#getFourUserPoi()
	 */
	public void getFourUserPoi() {
		ArrayList<String[]> dataArray1 = new ArrayList<String[]>();
		String[] poinum1 = recDao.getU1PoiFromFourUser();
		String[] poinum2 = recDao.getU2PoiFromFourUser();
		String[] poinum3 = recDao.getU3PoiFromFourUser();
		String[] poinum4 = recDao.getU4PoiFromFourUser();
		dataArray1.add(poinum1);
		dataArray1.add(poinum2);
		dataArray1.add(poinum3);
		dataArray1.add(poinum4);

		String[] temp = null;
		totalGoodsIDs = new ArrayList<String[]>();
		// for (String[] array : dataArray1) {
		// temp = new String[array.length];
		// System.arraycopy(array, 1, temp, 0, array.length);
		// // 将事务ID加入列表吧中
		// totalGoodsIDs.add(temp);
		// }
		totalGoodsIDs = dataArray1;
	}
	 ...
	 * 
	 * @see
	 * com.mine.mh.service.impl.IAprioriToolService#iSStrContain(java.lang.String
	 * [], java.lang.String[])
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.mine.mh.service.impl.IAprioriToolService#printAttachRule(double)
	 */
	 ...
	 * 
	 * @see
	 * com.mine.mh.service.impl.IAprioriToolService#strToint(java.lang.String[])
	 */
	public int[] strToint(String[] unique) {
		int[] num = new int[unique.length];
		for (int i = 0; i < num.length; i++) {
			num[i] = Integer.parseInt(unique[i]);
		}
		return num;
	}
